...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#0a0a0f] px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative z-0 w-full max-w-md">
        ...
        <div className="relative mt-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-zinc-900 text-gray-400">Or sign up with email</span>
          </div>
        </div>
