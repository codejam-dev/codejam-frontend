...
export default function RegisterPage() {
  ...
  const { register, initiateGoogleLogin, authState, clearError } = useAuth();
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Join CodeJam and start coding together
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              disabled={authState.loading || passwordErrors.length > 0}
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2 px-4 border border-gray-600 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
